...
| Flag | What it does |
| --- | --- |
| `--profile NAME` | Use a different account |
| `--format json\|pretty\|jsonl` | Output format |
| `--error-format json` | Machine-readable error envelope |
| `--debug` | Log requests to stderr, secrets redacted |
